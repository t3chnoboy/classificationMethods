...
angular.module('neuralClassifierApp')
  .controller 'NearestneighborCtrl', ($scope, Nearestneighbour, Datagenerator, Classifier, ClassificationFuncGenerator) ->
    ...
    $scope.init = ->
      ...
      plot = $.jqplot "nearestNeighbourPlot", [[[$scope.minX, $scope.minY], [$scope.maxX, $scope.maxY]], [], []],
        series:[
            showLine: false
          ,
            showLine: false
